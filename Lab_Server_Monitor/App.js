...
function GpuInfo(props) {
  // console.log(props.gpu_id_list);
  // console.log(props.gpu_memory_uses_list);
  // console.log(props.gpu_temperature_list);
...
function Ip_register(props) {
  let data_list = [
    ["140.115.51.64", "", "140.115.51.96", "謝承憲"],
    ["140.115.51.65", "張育珉", "140.115.51.97", "何立群"],
    ["140.115.51.66", "林宛儀", "140.115.51.98", "DLS"],
    ["140.115.51.67", "李易翰", "140.115.51.99", "何立群"],
    ["140.115.51.68", "右予", "140.115.51.100", "Fox1(website Nas)"],
    ["140.115.51.69", "", "140.115.51.101", "Foxking(博用Nas)"],
    ["140.115.51.70", "", "140.115.51.102", "DGX Station"],
    ["140.115.51.71", "HP4300黑白", "140.115.51.103", "Storage(Lab右後)"],
    ["140.115.51.72", "范(1080Ti*2)server", "140.115.51.104", ""],
    ["140.115.51.73", "楊仲軒", "140.115.51.105", "叢伯蘭"],
    ["140.115.51.74", "印表機", "140.115.51.106", "鄭(資料)server"],
    ["140.115.51.75", "鄭(專題生)server", "140.115.51.107", "鄭(碩一)server"],
    ["140.115.51.76", "鄭(在職)server", "140.115.51.108", "范(1080ti*2)"],
    ["140.115.51.77", "鄭媛", "140.115.51.109", "jack"],
    ["140.115.51.78", "鄭嘉元", "140.115.51.110", "jack"],
    ["140.115.51.79", "鄭老師作業serve", "140.115.51.111", "范(1080ti)server"],
    ["140.115.51.80", "鄭server", "140.115.51.112", ""],
    ["140.115.51.81", "鄭server", "140.115.51.113", "2080DL"],
    ["140.115.51.82", "PR LAB AP", "140.115.51.114", "范(1080ti*2)server"],
    ["140.115.51.83", "張維珊", "140.115.51.115", "范(3090)server"],
    ["140.115.51.84", "", "140.115.51.116", "范(3090)server"],
    ["140.115.51.85", "HP2420DN黑白", "140.115.51.117", "范(3090)server"],
    ["140.115.51.86", "", "140.115.51.118", "楊仲軒"],
    ["140.115.51.87", "", "140.115.51.119", "洪梓為"],
    ["140.115.51.88", "DEEPSTL", "140.115.51.120", ""],
    ["140.115.51.89", "叢伯蘭", "140.115.51.121", ""],
    ["140.115.51.90", "", "140.115.51.122", "wifi"],
    ["140.115.51.91", "", "140.115.51.123", "鄭server"],
    ["140.115.51.92", "張至妤", "140.115.51.124", ""],
    ["140.115.51.93", "王心妙", "140.115.51.125", "HP LJ500"],
    ["140.115.51.94", "", "140.115.51.126", "GSM 元智"],
    ["140.115.51.95", "", "140.115.51.127", "LAB FTP"],
  ];
  return (
...
class App extends React.Component {
  ...
  zhengClick() {
    let url = `http://140.115.51.102:9999/api/serverInfo/Z/`;
